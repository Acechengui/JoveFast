    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          <el-form-item
            v-if="activeData.__config__.tag === 'ts-universal-select'"
            label="请求接口"
          >
            <el-input v-model="activeData.requestApi" />
          </el-form-item>
          ...
          <el-form-item
            ...
            label="请求方式"
          >
            <el-input v-model="activeData.requestType" />
          </el-form-item>
          ...
          <el-form-item
            ...
            label="请求参数key"
          >
            <el-input v-model="activeData.requestKey" />
          </el-form-item>
          ...
          <el-form-item
            ...
            label="field"
          >
            <el-input v-model="activeData.field" />
          </el-form-item>
...
import tableDataDialog from "@/views/tool/build/tableDataDialog";
...
export default {
  ...
  methods: {
    ...
    addTableData() {
      ...
      this.currentNode = this.activeData.data;
    },
