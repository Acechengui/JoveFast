  ...
  <div class="app-container">
        ...
        <pane>
          <el-col size="84">
            <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
              ...
              <el-form-item label="英文昵称" prop="englishName">
                <el-input
            ...
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5">
                <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['system:user:add']">{{ $t('common.add') }}</el-button>
              </el-col>
              <el-col :span="1.5">
                <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['system:user:edit']">{{ $t('common.edit') }}</el-button>
              </el-col>
              <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['system:user:remove']">{{ $t('common.del') }}</el-button>
              </el-col>
              <el-col :span="1.5">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="英文昵称" align="center" key="englishName" prop="englishName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
              ...
              <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
                <template slot-scope="scope" v-if="scope.row.userId !== 1">
                  ...
                  <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['system:user:remove']">{{ $t('common.del') }}</el-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="英文昵称" prop="englishName">
              <el-input v-model="form.englishName" placeholder="请输入英文昵称" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        englishName: [
          { required: true, message: "英文昵称不能为空", trigger: "blur" },
          { min: 2, max: 20, message: '英文昵称长度必须介于 2 和 20 之间', trigger: 'blur' }
        ],
        nickName: [
