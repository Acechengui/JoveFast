...
<script>
import { listDefinition, updateState, delDeployment, addDeployment, updateDeployment,definitionStart, readXml} from "@/api/flowable/definition";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除选中的流程定义的数据项?', "警告", {
